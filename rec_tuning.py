...
def train(args):
    ...
    train_data["train"] = train_data["train"].shuffle(seed=args.seed).select(range(args.sample)) if args.sample > -1 \
        else train_data["train"].shuffle(seed=args.seed)
    train_data["train"] = train_data["train"].shuffle(seed=args.seed)
